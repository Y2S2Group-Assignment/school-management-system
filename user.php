                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="pt-3 pb-3">
                                    <a href="register.php">
                                        <button type="button" class="btn btn-primary w-15 float-right">Add New User</button>
                                    </a>
                                </div>
