            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Student Information List</h4>
                                <div class="pt-3 pb-3">
                                    <a href="c_information.php">
                                        <button type="button" class="btn btn-primary w-15 float-right">Add New Student Information</button>
                                    </a>
                                </div>
                                                    ...
                                                    <td>
                                                            ...
                                                            <!-- <button class="btn btn-outline-primary btn-sm edit_borrower"
                                                                ...
                                                                <div class="btn-group">
                                                                    ...
                                                                    <a class="dropdown-item"  href="stuDetail.php?stuDetail=<?php echo $row['StudentID'] ?> ">
                                                                    1. Detail
                                                                </a>
