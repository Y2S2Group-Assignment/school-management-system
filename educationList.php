        ...
        <?php
            ...
            $sql = "
                SELECT 
                    ...
                    tblsex.SexEN
                FROM tblstudentinfo
                INNER JOIN tbleducationalbackground ON tblstudentinfo.StudentID = tbleducationalbackground.StudentID
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Student Education List</h4>
                            <div class="pt-3 pb-3">
                                <a href="c_edu.php">
                                    <button type="button" class="btn btn-primary w-15 float-right">Add New Student Education</button>
                                </a>
                            </div>
