  ...
  <div class="container-scroller d-flex">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      if (isset($_GET['edit_batch'])) {
        $edit = $_GET['edit_batch'];
        $query = "SELECT * FROM tblbatch WHERE BatchID = $edit ";
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample pt-3" method="POST" action="action.php" enctype="multipart/form-data">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <input type="hidden" name="BatchID"
                            value="<?php echo isset($row['BatchID']) ? $row['BatchID'] : '' ?>">
                          ...
                          <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control border border-primary " id="exampleInputUsername1"
                              name="BatchKH" placeholder="Batch KH"
                              value="<?php echo isset($row['BatchKH']) ? $row['BatchKH'] : '' ?>">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control border border-primary " id="exampleInputUsername1"
                              name="BatchKH" placeholder="Batch EN"
                              value="<?php echo isset($row['BatchKH']) ? $row['BatchKH'] : '' ?>">
                          </div>
                        </div>
                      </div>
                    ...
                    <button type="submit" class="btn btn-primary" name="c_batch">Submit</button>
